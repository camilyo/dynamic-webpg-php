...
$toName = "Camila Santos-Oliveira"; //place your client's name here
...
if ($response != null && $response->success)
    ...
    <div class="contact-feedback">
        ...
        <p>We'll respond via email within 48 hours, if your requested information require a response.</p>
    </div>    
    <!-- END HTML FEEDBACK -->        
    <?php
